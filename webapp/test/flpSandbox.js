		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Cadastro",
									"targetURL": "#AppFioriDanielappfioridaniel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AppFioriDanielappfioridaniel-display": {
								"semanticObject": "AppFioriDanielappfioridaniel",
								"action": "display",
								"description": "App de cadastro de pessoas",
								"title": "App Cadastro",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=AppFioriDaniel.appfioridaniel",
									"url": sap.ui.require.toUrl("AppFioriDaniel/appfioridaniel")
								}
							}
						}
					}
